    ...
    <body class="cv-body" onload="cv_animation_underline()">
        ...
        <nav>
            <ul class="nav nav-justified nav-link">
                <li><a href="view/introduction.php">Hi, This is me. <span class="glyphicon glyphicon-queen"></span></a></li>
                <li><a>Work Road <span class="glyphicon glyphicon-road"></span></a></li>
                <li><a>Technical Initiatives <span class="glyphicon glyphicon-tasks"></span></a></li>
                <li><a>Educational Qualifications <span class="glyphicon glyphicon-education"></span></a></li>
                <li><a>I like to... <span class="glyphicon glyphicon-gift"></span></a></li>
            </ul>
        </nav>
    </body>
